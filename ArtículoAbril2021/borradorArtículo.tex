...
\begin{center}\includegraphics[width=350px]{mu_1_intervalsjer2} \end{center}

\textbf{Figure 2}. Log hazard rate for state random effect (95\%
Credible Interval)

\begin{center}\includegraphics[width=350px]{mu_12_intervalsjer2} \end{center}

\textbf{Figure 3}. Log hazard rate for healthcare provider random effect
(95\% Credible Interval)

\begin{center}\includegraphics[width=350px]{ppc_plot_jer2_mort} \end{center}
