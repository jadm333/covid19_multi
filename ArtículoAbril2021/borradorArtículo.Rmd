...
```{r,out.width="290px", echo =FALSE,fig.align='center'}
knitr::include_graphics("mu_12_intervalsjer2modi.png")
```
...
```
\textbf{Figure 5}. Effect on time from hospitalization to death by covariates included in the final model.
