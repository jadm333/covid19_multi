...
Based on Model II, we considered an extra random effect $\mathbf{\mu}_k, \space l=1,...,6$ which take into account the healthcare provider previously described. Because of this, an extra dispersion parameter $\sigma$ is added. This part of the model is described in light pink in Figure 1.
...
```
\textbf{Figure 3}. Log hazard rate for healthcare provider random effect (95% Credible Interval)

```{r,out.width="350px", echo =FALSE,fig.align='center'}
knitr::include_graphics("ppc_plot_jer2_mort.png")
```
\textbf{Figure 4}. Posterior predictive distribution density plot for deaths
