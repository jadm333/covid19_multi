...
$HOME/covid19_multi/Stan/ModeloQR_reduce sample num_samples=750 num_warmup=500  data file=$HOME/covid19_multi/Cmdstan/sin_jer.json init=$HOME/covid19_multi/Cmdstan/inits_${SLURM_ARRAY_TASK_ID}.json \
output file=$SCRATCH/multi/sin_jer_${SLURM_ARRAY_TASK_ID}.csv
