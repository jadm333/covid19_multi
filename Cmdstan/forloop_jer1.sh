...
$HOME/covid19_multi/Stan/ModeloJerQR_reduce sample num_samples=750 num_warmup=500  data file=$HOME/covid19_multi/Cmdstan/jer_1.json init=$HOME/covid19_multi/Cmdstan/inits_${SLURM_ARRAY_TASK_ID}.json \
output file=$SCRATCH/multi/jer1_${SLURM_ARRAY_TASK_ID}.csv
