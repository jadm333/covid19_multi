...
$HOME/covid19_multi/Stan/ModeloJer2QR_reduce sample num_samples=750 num_warmup=750  data file=$HOME/covid19_multi/Cmdstan/jer_2.json init=$HOME/covid19_multi/Cmdstan/inits_${SLURM_ARRAY_TASK_ID}.json \
output file=$SCRATCH/jer2/jer2_${SLURM_ARRAY_TASK_ID}.csv
