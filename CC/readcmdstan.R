...
#set working directory to covid19_multi directory
...
ggsave("./CC/jer2modi/ppc_plot_modi_hosp.png",ppc_plot_modi_hosp,width = 23.05,height = 17.57,units="cm")
...
ggsave("./CC/jer1/ppc_plot_jer1_hosp.png",ppc_plot_jer1_hosp,width = 23.05,height = 17.57,units="cm")
...
ggsave("./CC/sinjer/ppc_plot_sinjer_hosp.png",ppc_plot_sinjer_hosp,width = 23.05,height = 17.57,units="cm")
