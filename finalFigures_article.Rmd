...
```{r,fig.cap="Hazard rate by logarithmic scale by state, credible interval 95%"}
knitr::include_graphics("./CC/jer2/mu_1_intervalsjer2.png")

```

```{r,fig.cap="Hazard rate by logarithmic scale by health institution, credible interval 95%"}
knitr::include_graphics("./CC/jer2/mu_12_intervalsjer2.png")

```

```{r,fig.cap="Predictive distribution for deaths jer2"}
